...
| [#8](https://github.com/ludo-lang/ludo/issues/8) | Choose the memory model | authoritative | ADR-0042 adds the allocator's *shape*; #8's model is untouched. |
