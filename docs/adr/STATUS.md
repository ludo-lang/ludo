...
ADR-0006 | amended | eight forbidding/requiring rules (R1-R8) constrain the platform-layer API for browser/reload compatibility, and mandate a voice-based audio addition | amended-by:0007, amended-by:0014, amended-by:0033
